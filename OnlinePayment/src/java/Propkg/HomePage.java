...
public class HomePage extends HttpServlet { 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int sta = Propkg.Processes.transaction(Sname,pass,Rname,Rphn,amt);
...
"                                 margin: 45px;\"</center> ");
            if(sta<0)
            {
                pr.println("<br><B><font size=\"5\" style=\"color:red\">ERROR!!</font><br><br>"+Propkg.Processes.mesg);
            ...
            {
                pr.println("<br><font style=\"color:green\">"+Propkg.Processes.mesg+"</font>");
...
"                                 margin: 45px;\"</center> ");
            ...
            {
            pr.print(Propkg.Processes.messg);
            ...
            {
                int status = Propkg.Processes.Balance(Sname);
                if(status>0)
                {
                    pr.print(Propkg.Processes.messg);
                    pr.print("<form action=\"Home.html\"><input type=\"submit\" value= \"Go back to Home Page.\" ><br></div></center> </body>");
